...
app.post('/', async (req, res) => {
    ...
    try {
        ...
        const T_60K  = parseFloat(columnas[2]); // C2
        const T_250K = parseFloat(columnas[3]); // D2
        const BCV    = parseFloat(columnas[5]); // F2

        // 2. Extraer monto (AutoResponder envía el mensaje en 'query' o 'message')
